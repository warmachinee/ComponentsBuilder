...
export function arrow_back(props){
  const { color, width, height, style } = props
  return(
    <svg style={{width: (width)?width:'24px',height: (height)?height:'24px'}}
      xmlns="http://www.w3.org/2000/svg" width={(width)?width:24} height={(height)?height:24} viewBox="0 0 24 24">
